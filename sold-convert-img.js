// tolong buat convert dari folder img convert ke folder img-sold
...
const inputFolder = path.join(__dirname, 'public/img-sold');
const outputFolder = path.join(__dirname, 'public/img-sold-webp');
...
// Panggil fungsi untuk mengonversi gambar
convertPNGtoWebP();
